      ...
      return <div>
         <AppNavBarOrganization/>
          ...
          <form>
                            ...
                            <legend className='legend' >เพิ่มข้อมูล:</legend>
                        ...
                        <FormGroup style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
                            <Button style={{marginLeft:40,background: '#FFB6C1',color: '#000066'}} type="submit">บันทึก</Button>
                            <Button style={{marginLeft:40,background: '#FFB6C1',color: '#000066'}} type="submit">กลับ</Button>
                        </FormGroup>
          </Container> 
