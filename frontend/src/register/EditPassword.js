                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <form>
                            <fieldset className='my-fieldset'>
                                ...
                                <div className="row" className='a'>
                                <AvForm className="col-md-8 mb-3" >
                                        <AvField name="password" label="รหัสผ่านปัจจุบัน" type="text" errorMessage="Invalid name" 
                                        validate={{
                                            required: { value: true },
                                            pattern: { value: /\w*\s\w*/ }
                                        }}
                                     ...
                                     <AvForm className="col-md-8 mb-3" >
                                        <AvField name="newpassword" label="รหัสผ่านใหม่" type="text" errorMessage="Invalid name" 
                                     validate={{
                                             required: { value: true },
                                         pattern: { value: '^[0-9]{10}$' }
                                     }}
                        ...
                        <FormGroup style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
                            ...
                            <Button style={{marginLeft:40}} color="primary" type="submit">กลับ</Button>
                        </FormGroup>
