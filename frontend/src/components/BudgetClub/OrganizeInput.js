          ...
          <form>
                            ...
                            <legend className='legend' >Profile:</legend>
                                ...
                                <AvForm className="col-md-8 mb-3" >
                                    ...
                                    <FormGroup className="col-md-8 mb-3">
                                        ...
                                        <Select placeholder="ตำแหน่ง"
                                          ...
                                          >
                                            ...
                                            <MenuItem value={30}>ประธาน</MenuItem>
                                            <MenuItem value={30}>รองประธาน</MenuItem>
                                        </Select>
                                    </FormGroup>

                                   
                                       <AvForm className="col-md-8 mb-3" >
                                        <AvField name="tel" label="ID:" type="text" errorMessage="Invalid name" 
                                        validate={{
                                            required: { value: true },
                                            pattern: { value: /\w*\s\w*/ }
                                        }}
                                    ...
                                    <AvForm className="col-md-8 mb-3" >
                                        <AvField name="conferm" label="ยืนยันรหัสผ่าน" type="text" errorMessage="Invalid name" 
                                        validate={{
                                            required: { value: true },
                                            pattern: { value: /^[A-Za-z]{1,20}$/ }
                                        }}
                        ...
                        <FormGroup style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
                            <Button style={{background: '#FFB6C1',color: '#000066'}} type="submit">บันทึก</Button>
                            <Button style={{background: '#FFB6C1',color: '#000066',marginLeft:40}} type="submit">กลับ</Button>
                        </FormGroup>
          </Container> 
